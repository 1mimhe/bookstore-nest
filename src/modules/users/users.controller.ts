import { BadRequestException, Body, Controller, Post, Res, Session } from '@nestjs/common';
...
export class UsersController {
  ...
  @ApiOperation({ 
    ...
    description: 'Login a user and returns an access token with 20m expiration time'
  })
  @ApiBadRequestResponse({
